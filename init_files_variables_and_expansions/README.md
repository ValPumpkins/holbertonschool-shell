...
<li><strong>17-water_and_stir</strong> : Adds the two numbers stored in the environment variables WATER and STIR and prints the result. (WATER is in base water & STIR is in base stir. The result should be in base bestchol)</li>
</ul>
